# This dockerfile uses extends image https://hub.docker.com/woodpecker-kit/woodpecker-gitea-publisher-golang
# VERSION 1
...
ARG GO_ENV_PACKAGE_NAME=github.com/woodpecker-kit/woodpecker-gitea-publisher-golang
ARG GO_ENV_ROOT_BUILD_BIN_NAME=woodpecker-gitea-publisher-golang
ARG GO_ENV_ROOT_BUILD_BIN_PATH=build/${GO_ENV_ROOT_BUILD_BIN_NAME}
ARG GO_ENV_ROOT_BUILD_ENTRANCE=cmd/woodpecker-gitea-publisher-golang/main.go
...
ENTRYPOINT [ "/app/woodpecker-gitea-publisher-golang" ]
# CMD ["/app/woodpecker-gitea-publisher-golang", "--help"]
